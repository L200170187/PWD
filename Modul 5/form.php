...
<input type ='radio' value='radio' value='B' name='kelas'>B
...
<td align='center' width='23%'><b>Nama</b></td>
...
while($data=mysqli_fetch_row($hasil_cari)){
    echo"
        <tr> width='20%'>$data[0]</td>
        <tr> width='30%'>$data[1]</td>
        <tr> width='10%'>$data[2]</td>
        <tr> width='30%'>$data[3]</td>
        </tr>"
}
?>
